                            ...
                            <form action="{{ route('register') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter the Name" name="name" :value="old('name')" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    @error('email')
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter the Email" name="email" :value="old('email')">
                                    </div>
                                </div>
                                <div class="form-group">
                                    @error('password')
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter the Password" name="password">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter Retype Password" name="password_confirmation">
                                    </div>
                                </div>
                                  <div class="row">
                                    <div class="col-12">
