                        ...
                        <div class="sidebar-filter">
                            ...
                            <div class="sidebar-widget wow fadeInUp">
                                ...
                                <div class="sidebar-widget-body">
                                    <div class="accordion">
                                        @foreach($sub_subcategoies as $category)
                                        <div class="accordion-group">
                                            ...
                                            <div class="accordion-body collapse" id="collapseOne{{ $category->id }}" style="height: 0px;">
                                                <div class="accordion-inner">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="{{ url('subsubcategory-product/'.$subsubcategory->id.'/'.$subsubcategory->subsubcategory_slug) }}">{{ $subcategory->subcategory_name }}</a>
                                                        </li>
                                                    </ul>
                                                    @empty
                            ...
                            <div class="tab-pane active " id="grid-container">
                                <div class="category-product">
                                    <div class="row">
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"><a href="{{ url('product-details/'.$product->id.'/'.$product->product_slug ) }}"><img src="{{ asset($product->product_thambnail) }}" alt=""></a>
                                                        </div>
                                                        <!-- /.image -->
                                                        <!-- //////////////Not Work///////////////  -->
                                        ...
                                        @empty
                                        <span class="text-danger">There Are No Product Found</span>
                                        @endforelse
                                        <!-- /.item -->
