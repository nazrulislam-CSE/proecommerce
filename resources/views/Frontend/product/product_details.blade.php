                ...
                <div class='col-md-9'>
                                        ...
                                        <div id="owl-single-product-thumbnails">
                                            ...
                                            <div class="item">
                                                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide{{ $img->id }}">
                                                    <img class="img-responsive" width="85" alt="" src="{{ $img->photo_name }}" data-echo="{{ asset($img->photo_name)}}"/>
                                                </a>
                                            </div>
                                            @endforeach
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                 <h1 class="name" id="pname">{{ $product->product_name }}</h1>
                                    ...
                                    <!-- /// EndAdd Product Color And Product Size /// -->
                    ...
                    <section class="section featured-product wow fadeInUp">
                        ...
                        <div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
                            ...
                            @empty
                            <span class="text-danger p-3">There Are No Product Found</span>
                            @endforelse
