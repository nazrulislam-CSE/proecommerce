            ...
            @foreach($orders as $order)
              <tr>
                ...
                <td class="col-md-1">
                  ...
                  <a href="{{ route('orders_details',$order->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i> View</a>

                  <a target="_blank" href="{{ route('invoice_download',$order->id) }}" class="btn btn-sm btn-danger" style="margin-top: 5px;"><i class="fa fa-download" style="color: white;"></i> Invoice </a>
                </td>
              </tr>
            @endforeach
