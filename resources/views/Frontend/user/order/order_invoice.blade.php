  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Easy Online Flipmart Shop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Classic It & Sky Mart Ltd Office
               Email:classicitltd@gmail.com <br>
               Mob: 01701245365
               <br>
              House # 37 (3'rd Floor), Road # 8, Sector # 12, Uttara, Dhaka-1230. <br>
