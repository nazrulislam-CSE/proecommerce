				...
				<div class="box">
                    ...
                    @endif
									...
									<td>
										...
										<a href="{{ route('category.trash',['id'=>$item->id]) }}" id="trash" class="btn btn-danger btn-rounded"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								@endforeach()
							</tbody>
					...
					<div class="box-body">
						<form action="{{ route('category.store') }}" method="post" class="form-horizontal form-element col-12">
							...
							<div class="form-group">
								...
								@enderror()
								<input type="text" name="category_name" class="form-control" id="name" placeholder="Enter the category name">
							</div>
							<div class="form-group">
