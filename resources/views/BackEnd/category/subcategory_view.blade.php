							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="{{ route('subcategory.delete',['id'=>$item->id]) }}" id="delete" class="btn btn-danger btn-rounded"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								@endforeach()
							</tbody>
					...
					<div class="box-body">
						<form action="{{ route('subcategory.store') }}" method="post" class="form-horizontal form-element col-12">
							...
							<div class="form-group">
								...
								@enderror()
								<input type="text" name="subcategory_name" class="form-control" id="subcategory_name" placeholder="Enter the subcategory name">
							</div>
							<div class="form-group">
