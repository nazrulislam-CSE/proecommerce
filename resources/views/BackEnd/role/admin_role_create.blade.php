		  ...
		  <div class="row">
		  	<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
						<form action="{{ route('admin.user.store')}}" method="post" class="form-horizontal form-element col-12" enctype="multipart/form-data">
							{{ csrf_field() }}
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<img id="showImage" src="{{ url('uploads/no_image.jpg') }}" required="" style="width: 100px; height: 100px;">
								</div>
							</div><!-- end row 	 -->
							<hr>
							<div class="row">
