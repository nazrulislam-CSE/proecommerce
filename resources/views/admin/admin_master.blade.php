  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar"> 
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        ">
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'admin.profile')? 'active':'' }}"><a href="{{ route('admin.profile') }}"><i class="ti-more"></i>Admin Profile</a></li>
        ...
        ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'brand.trashed')? 'active':'' }}"><a href="{{ route('brand.trashed') }}"><i class="ti-more"></i>Trashed Brand</a></li>
          </ul>
        </li>

        <li class="treeview 
        {{ ($prefix == '/category')?'active':'' }}
        ...
        ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'category.trashed')? 'active':'' }}"><a href="{{ route('category.trashed') }}"><i class="ti-more"></i>Trashed Category</a></li>
            <li class="{{ ($route == 'subcategory.all')? 'active':'' }}"><a href="{{ route('subcategory.all') }}"><i class="ti-more"></i>All SubCategory</a></li>
            <li class="{{ ($route == 'subcategory.trashed')? 'active':'' }}"><a href="{{ route('subcategory.trashed') }}"><i class="ti-more"></i>Trashed SubCategory</a></li>
            <li class="{{ ($route == 'subsubcategory.all')? 'active':'' }}"><a href="{{ route('subsubcategory.all') }}"><i class="ti-more"></i>All Sub->SubCategory</a></li>
            <li class="{{ ($route == 'subsubcategory.trashed')? 'active':'' }}"><a href="{{ route('subsubcategory.trashed')}}"><i class="ti-more"></i>Trashed Sub->SubCategory</a></li>
          </ul>
        </li>
        ...
        ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'product.trashed')? 'active':'' }}"><a href="{{ route('product.trashed') }}"><i class="ti-more"></i>Trashed Product</a></li>
          </ul>
        </li>

        <li class="treeview 
        {{ ($prefix == '/slider')?'active':'' }}
       ...
       ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'slider.trashed')? 'active':'' }}"><a href="{{ route('slider.trashed') }}"><i class="ti-more"></i>Trashed Slider</a></li>
          </ul>
        </li>

        <li class="treeview
        {{ ($prefix == '/coupon')?'active':'' }}
      ...
      ">
        ...
        <li class="treeview
        {{ ($prefix == '/alluser')?'active':'' }}

        {{ ($route == 'user.edit')? 'active':'' }}
        ">
          <a href="#" class="nav-link">
            <i data-feather="message-circle"></i>
            <span>All Users</span>
       ...
       ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'view.post.list')? 'active':'' }}"><a href="{{ route('view.post.list') }}"><i class="ti-more"></i>View Post list</a></li>
          </ul>
        </li>

        <li class="treeview
        {{ ($prefix == '/setting')?'active':'' }}
       ">
          <a href="#" class="nav-link">
            <i data-feather="message-circle"></i>
